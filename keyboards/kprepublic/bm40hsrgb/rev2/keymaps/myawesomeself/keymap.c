...
[_COLEMAK] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_MPLY, HL_NUM,  VIM_SPC, KC_BSPC, HM_LYR,  RMT,     RGB_LYR, QWRTY_LYR
),
...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_MPLY, HL_NUM,  KC_SPC,  KC_BSPC, HM_LYR,  RMT,     RGB_LYR, DVRK_LYR
),
...
[_DVORAK] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_MPLY, HL_NUM,  VIM_SPC, KC_BSPC, HM_LYR,  RMT,     RGB_LYR, CLMK_LYR
),
